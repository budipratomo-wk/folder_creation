...
class MapOfstringAndstring(object):
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """MapOfstringAndstring - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MapOfstringAndstring, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MapOfstringAndstring):
            return False

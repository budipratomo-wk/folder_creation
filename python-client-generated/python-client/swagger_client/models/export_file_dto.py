...
class ExportFileDto(object):
    ...
    def __init__(self, url=None, _configuration=None):  # noqa: E501
        """ExportFileDto - a model defined in Swagger"""  # noqa: E501
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this ExportFileDto.

        URL of the spreadsheet to export to, if present. If not present, a new spreadsheet will be created.  # noqa: E501

        :param url: The url of this ExportFileDto.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ExportFileDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExportFileDto):
            return False

...
class MapOfstringAndobject(object):
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """MapOfstringAndobject - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MapOfstringAndobject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MapOfstringAndobject):
            return False
